...
Released in a single day (2026-05-26) as a chain of small fixes. The latest release in the chain is the version HACS will install. Earlier v0.39.x tags exist in the release history for traceability but are superseded.
...
**EV controller — three related fixes (v0.39.10, v0.39.11, v0.39.12).**
