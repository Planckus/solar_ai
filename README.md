...
Both files share the same single-screen layout (the English file is a full translation of the Danish one). Note: some on-screen text is generated by the integration (status reasons, operating-mode names) and currently renders in Danish regardless of which dashboard you import.
